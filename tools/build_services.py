...
PHOTOS = {
    ...
    "electric-fence": "/assets/photos/electric-fence-wall-top.jpg",
    "gates-fabrication": "/assets/photos/custom-steel-gate.jpg",
...
<script src="/assets/main.js?v=8" defer></script>
</body>
</html>
'''
